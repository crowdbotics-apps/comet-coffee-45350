"""
Django settings for comic_coffee_45350 project.
...
ROOT_URLCONF = 'comic_coffee_45350.urls'
...
WSGI_APPLICATION = 'comic_coffee_45350.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "comic_coffee_45350 API",
    "DESCRIPTION": "API documentation for comic_coffee_45350 App",
    "VERSION": "v1",
}
